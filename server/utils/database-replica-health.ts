 ...
 */
function getReplicaPool(replicaUrl: string): Pool {
  if (!replicaPool) {
 ...
 */
export async function checkReplicaHealth(replicaUrl?: string): Promise<ReplicaHealth> {
 ...
 */
export function startReplicaHealthMonitoring(intervalMs = 30000): NodeJS.Timeout {
