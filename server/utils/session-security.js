...
const sessionInvalidationCallbacks = new Set();
export function registerSessionInvalidationCallback(callback) {
...
async function notifySessionInvalidation(sessionId, userId, reason) {
 ...
 */
export async function regenerateSessionId(oldSessionId, userId, reason, fingerprint) {
    try {
 ...
 */
export async function validateSessionSecurity(sessionId, req) {
    const reasons = [];
    let valid = true;
 ...
 */
export async function rotateSessionAfterPrivilegeChange(sessionId, userId, newRole, req) {
 ...
 */
export async function logSecurityEvent(sessionId, userId, eventType, metadata) {
 ...
 */
export async function invalidateSession(sessionId, userId, reason) {
 ...
 */
export async function invalidateAllUserSessions(userId, reason, exceptSessionId) {
 ...
 * Uses __Host- prefix in production for enhanced security
 */
export function getSessionCookieName(cookieBaseName) {
    const isProduction = process.env.NODE_ENV === 'production';
 ...
 */
export function generateTlsFingerprint(req) {
    try {
 ...
 */
export function validateTlsBinding(req, sessionTlsFingerprint) {
