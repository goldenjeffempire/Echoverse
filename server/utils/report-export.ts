 ...
 * Export data as CSV
 */
export function exportCSV(res: Response, report: ReportData): void {
  try {
 ...
 * Export data as PDF
 */
export function exportPDF(res: Response, report: ReportData): void {
  try {
 ...
 */
export function exportReport(res: Response, report: ReportData, format: 'csv' | 'pdf' = 'csv'): void {
  if (format === 'pdf') {
