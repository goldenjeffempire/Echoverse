 ...
 */
export function sanitizeAIPrompt(prompt, maxLength = 5000) {
...
export function sanitizeArray(arr, options = {}) {
    const { maxItems = 100, itemMaxLength = 500, allowHtml = false } = options;
 ...
 */
export function sanitizeObject(obj, options = {}, currentDepth = 0) {
