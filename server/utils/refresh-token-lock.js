 ...
 */
export async function acquireRefreshLock(sessionId, attempt = 1) {
    const now = Date.now();
 ...
 */
export function releaseRefreshLock(sessionId) {
 ...
 */
export function hasActiveLock(sessionId) {
 ...
 */
export function clearAllRefreshLocks() {
