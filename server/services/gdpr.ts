 ...
 */
export async function deleteUserData(userId: string, keepAnonymizedData: boolean = false): Promise<void> {
  try {
...
const consentStore = new Map<string, CookieConsent>();

export function recordCookieConsent(consent: CookieConsent): void {
...
export function getCookieConsent(sessionId: string): CookieConsent | null {
