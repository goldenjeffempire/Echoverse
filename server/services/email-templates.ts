...
export const emailTemplates = {
  welcome: (data: { name: string; verificationUrl: string }): EmailTemplate => ({
  ...
  orderConfirmation: (data: { orderNumber: string; total: number; items: any[] }): EmailTemplate => ({
...
export function renderEmailTemplate(templateName: keyof typeof emailTemplates, data: any): EmailTemplate {
