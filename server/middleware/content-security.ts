...
export function validateContentType(
  ...
  return (req: Request, res: Response, next: NextFunction): void => {
    ...
    if (!isValid) {
      ...
      throw new AppError(
        415,
        `Unsupported Media Type. Expected: ${allowedTypes.join(' or ')}`,
 ...
 */
export function requireImageUpload(req: Request, res: Response, next: NextFunction): void {
  if (!req.file) {
 ...
 */
export function validateFileExtension(file: Express.Multer.File): boolean {
