...
export function NativeFeaturesDemo() {
    const { isNative, deviceInfo, networkStatus, takePicture, pickImage, shareContent, vibrate } = useNativeFeatures();
    ...
    const handleShare = async () => {
        await shareContent('EchoVerse', 'Check out EchoVerse - AI-powered website builder!', 'https://echoverse.com');
    };
    ...
    return (<div className="p-4 space-y-4">
      <div className="space-y-2">
        ...
        {deviceInfo && (<div className="text-sm space-y-1">
      ...
      {networkStatus && (<div className="space-y-2">
