...
export default function ApiReferencePage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950">
      <Navbar />
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
        ...
        ].map((item, index) => (<Card key={index} className="border-0 shadow-xl">
          ...
          <div className="space-y-4">
            ...
            {endpoints.map((endpoint, index) => (<motion.div key={index} initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
