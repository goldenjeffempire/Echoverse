...
import { ArrowRight, Sparkles, Zap, Globe, ShoppingCart, MessageSquare, TrendingUp, Puzzle, Shield, Check, Star, Users, Rocket, BarChart, Code, Layers, Cpu, Wand2, Palette, BookOpen, Award, ChevronRight } from "lucide-react";
...
export default function HomePage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950 overflow-hidden">
      ...
      <section className="relative pt-32 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <motion.img src="/attached_assets/stock_images/futuristic_ai_techno_78868d22.jpg" alt="AI Technology Workspace" className="w-full h-full object-cover opacity-40" initial={{ scale: 1.1 }} animate={{ scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }}/>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center relative z-10">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <motion.h1 className="text-6xl md:text-8xl font-black mb-8 leading-tight" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.7 }}>
                <span className="bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">
                  Build, Sell, & Scale
                </span>
                <br />
                <motion.span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent inline-block" animate={{
            ...
            ease: "linear"
              ...
              <motion.p className="text-xl md:text-2xl text-slate-200 dark:text-slate-200 mb-10 max-w-4xl mx-auto leading-relaxed" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 0.7 }}>
              ...
              <motion.div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.6 }}>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white px-10 py-6 text-lg font-semibold shadow-2xl hover:shadow-blue-500/50 transition-all" onClick={handleGetStarted}>
                    Start Building Free
                    <ArrowRight className="ml-2 w-6 h-6"/>
                  </Button>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" variant="outline" className="px-10 py-6 text-lg font-semibold border-2 hover:bg-blue-50 dark:hover:bg-blue-950 transition-all" onClick={handleDashboard}>
                    Explore Dashboard
                  </Button>
                </motion.div>
              </motion.div>
              ...
              {/* Trust Indicators */}
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 0.6 }} className="flex flex-wrap justify-center gap-8 text-sm text-slate-200">
            ...
            <motion.div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-20 blur-2xl" animate={{
            y: [0, -30, 0],
            scale: [1, 1.2, 1],
            rotate: [0, 10, 0]
        }} transition={{
            ...
            <motion.div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full opacity-20 blur-2xl" animate={{
            y: [0, 20, 0],
            scale: [1, 1.1, 1],
            rotate: [0, -5, 0]
        }} transition={{
            ...
            <motion.div className="absolute bottom-20 left-1/4 w-28 h-28 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full opacity-15 blur-2xl" animate={{
            y: [0, -20, 0],
            scale: [1, 1.15, 1],
        }} transition={{
            duration: 7,
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              ...
              <div className="space-y-4">
                {['Natural language input', 'Instant generation', 'Fully customizable', 'Production-ready code'].map((item, idx) => (<motion.div key={idx} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 + (idx * 0.1) }} className="flex items-center gap-3">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-3xl blur-3xl"/>
              <motion.img src="/attached_assets/stock_images/modern_website_build_48e9aeb4.jpg" alt="Website Builder Interface" className="relative rounded-2xl shadow-2xl w-full h-auto" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}/>
            </motion.div>
          </div>
        </div>
      </motion.section>
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="py-20 px-4 sm:px-6 lg:px-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-y border-slate-200 dark:border-slate-800 relative z-10">
        <div className="max-w-7xl mx-auto">
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {stats.map((stat, index) => (<motion.div key={index} variants={scaleIn} whileHover={{ scale: 1.1, y: -5 }} className="relative group">
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/30 dark:to-red-950/30">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
        ...
        ].map((item, idx) => (<motion.div key={idx} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 + (idx * 0.1) }} className="flex items-center gap-3">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              ...
              <motion.img src="/attached_assets/stock_images/digital_marketing_da_468a0a44.jpg" alt="Marketing Analytics Dashboard" className="relative rounded-2xl shadow-2xl w-full h-auto" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}/>
            </motion.div>
          </div>
        </div>
      </motion.section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950/30 dark:via-purple-950/30 dark:to-pink-950/30">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {aiFeatures.map((feature, index) => (<motion.div key={index} variants={fadeInUp}>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="grid md:grid-cols-2 gap-8 mb-16">
            <motion.div whileHover={{ scale: 1.02 }} className="relative group">
              ...
              <Card className="relative border-0 overflow-hidden shadow-2xl">
                <CardContent className="p-0">
                  <img src="/attached_assets/stock_images/ai_artificial_intell_10494fca.jpg" alt="AI Chatbot Assistant" className="w-full h-64 object-cover"/>
                  <div className="p-6 bg-white dark:bg-slate-800">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Natural Language', 'Multi-lingual', '24/7 Support'].map((tag) => (<Badge key={tag} className="bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                          {tag}
                        </Badge>))}
                    </div>
                  </div>
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="relative group">
              ...
              <Card className="relative border-0 overflow-hidden shadow-2xl">
                <CardContent className="p-0">
                  <img src="/attached_assets/stock_images/website_design_creat_04708a16.jpg" alt="AI Content Generation" className="w-full h-64 object-cover"/>
                  <div className="p-6 bg-white dark:bg-slate-800">
                    <h3 className="text-2xl font-black mb-3 text-slate-900 dark:text-white">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['SEO Optimized', 'Brand Voice', 'Instant'].map((tag) => (<Badge key={tag} className="bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300">
                          {tag}
                        </Badge>))}
                    </div>
                  </div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-2xl">
        ...
        ].map((capability, idx) => (<motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }} className="flex gap-4">
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (<motion.div key={index} variants={fadeInUp} onHoverStart={() => setHoveredFeature(index)} onHoverEnd={() => setHoveredFeature(null)}>
                <motion.div whileHover={{ y: -10, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card className={`h-full border-0 shadow-xl hover:shadow-2xl transition-all overflow-hidden group ${hoveredFeature === index ? 'bg-gradient-to-br ' + feature.gradient : 'bg-white dark:bg-slate-800'}`}>
                    <CardContent className="p-8 relative">
                      ...
                      <motion.div className="mt-4 flex items-center text-blue-600 dark:text-blue-400 font-semibold opacity-0 group-hover:opacity-100 transition-opacity relative z-10" initial={{ x: -10 }} animate={{ x: hoveredFeature === index ? 0 : -10 }}>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-3 gap-12 relative">
            {/* Connection Lines */}
            ...
            {howItWorks.map((step, index) => (<motion.div key={index} variants={fadeInUp} className="relative">
                    ...
                    <CardContent className="p-8 text-center relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <div className="relative inline-block mb-6">
                          <motion.div className={`w-20 h-20 ${step.color} rounded-2xl flex items-center justify-center shadow-xl`} whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-2 md:order-1 relative">
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 to-emerald-600/20 rounded-3xl blur-3xl"/>
              <motion.img src="/attached_assets/stock_images/successful_online_bu_c08662cf.jpg" alt="E-Commerce Success" className="relative rounded-2xl shadow-2xl w-full h-auto" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}/>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="order-1 md:order-2">
              <Badge className="mb-4 bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300">
        ...
        ].map((item, idx) => (<motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 + (idx * 0.1) }} className="bg-white dark:bg-slate-800 rounded-xl p-4 border border-green-200 dark:border-green-800">
      ...
      <motion.section initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              <Badge className="mb-4 bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              ...
              <motion.img src="/attached_assets/stock_images/happy_diverse_team_c_cc06b103.jpg" alt="Team Collaboration" className="relative rounded-2xl shadow-2xl w-full h-auto" whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}/>
            </motion.div>
          </div>
        </div>
      </motion.section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (<motion.div key={index} variants={fadeInUp}>
                  ...
                  <Card className={`h-full border-0 bg-gradient-to-br ${useCase.color} p-8 text-white shadow-2xl hover:shadow-3xl transition-all relative overflow-hidden group`}>
                    ...
                    <CardContent className="p-0 relative z-10">
                      <div className="flex items-start gap-6">
                        <motion.div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm shadow-xl" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div className="flex flex-wrap justify-center gap-6" variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }}>
            {integrations.map((integration, index) => (<motion.div key={index} variants={scaleIn} whileHover={{ scale: 1.1, y: -5 }} className="w-32 h-32 bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-2xl flex flex-col items-center justify-center gap-2 border border-slate-200 dark:border-slate-700 transition-all">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (<motion.div key={index} variants={fadeInUp}>
                <motion.div whileHover={{ y: -10, scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card className="h-full border-0 bg-white dark:bg-slate-800 shadow-xl hover:shadow-2xl transition-all">
                    <CardContent className="p-8">
                      <div className="flex gap-1 mb-6">
                        {[...Array(testimonial.rating)].map((_, i) => (<motion.div key={i} initial={{ scale: 0, rotate: -180 }} animate={{ scale: 1, rotate: 0 }} transition={{ delay: 0.1 * i }}>
      ...
      <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }} className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (<motion.div key={index} variants={fadeInUp}>
                <motion.div whileHover={{ scale: plan.popular ? 1.05 : 1.02, y: -10 }} transition={{ type: "spring", stiffness: 300 }}>
                  <Card className={`h-full ${plan.popular ? 'border-4 border-blue-500 shadow-2xl scale-105 relative' : 'border-0 shadow-xl'} bg-white dark:bg-slate-800 transition-all`}>
                    {plan.popular && (<motion.div className="absolute -top-5 left-1/2 transform -translate-x-1/2" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", stiffness: 300 }}>
                    ...
                    <CardContent className="p-8">
                      <div className="text-center mb-8">
                        ...
                        <Button className={`w-full py-6 text-lg font-semibold ${plan.popular
                ? `bg-gradient-to-r ${plan.gradient} text-white shadow-xl hover:shadow-2xl`
                : 'bg-slate-900 dark:bg-white text-white dark:text-slate-900'}`} onClick={handleGetStarted}>
                          Get Started
                          <ArrowRight className="ml-2 w-5 h-5"/>
                        </Button>
                      </div>
                      <div className="space-y-4">
                        {plan.features.map((feature, i) => (<motion.div key={i} className="flex items-start gap-3" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }}>
      ...
      <motion.section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <motion.h2 className="text-5xl md:text-7xl font-black mb-8 text-white" animate={{
            textShadow: [
            ...
            <motion.div className="flex flex-col sm:flex-row gap-6 justify-center items-center" variants={stagger} initial="initial" whileInView="animate" viewport={{ once: true }}>
              <motion.div variants={scaleIn} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 px-12 py-7 text-xl font-bold shadow-2xl" onClick={handleGetStarted}>
                  Start Building Free
                  <ArrowRight className="ml-3 w-6 h-6"/>
                </Button>
              </motion.div>
              <motion.div variants={scaleIn} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" variant="outline" className="bg-transparent border-2 border-white text-white hover:bg-white/10 px-12 py-7 text-xl font-bold" onClick={() => setLocation('/dashboard')}>
                  View Demo
                </Button>
              </motion.div>
            </motion.div>
