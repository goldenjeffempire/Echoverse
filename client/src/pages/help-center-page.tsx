  ...
  >
    <Link href={link}>
      <div className="p-6 cursor-pointer">
        <div
          className={`w-12 h-12 rounded-lg flex items-center justify-center text-white mb-4 ${color}`}
        >
          {icon}
        </div>
      ...
      items: [
        {
          ...
          answer: "Click 'Sign Up' on the homepage. Provide your email, set a username/password, and verify your email.",
        },
        {
          question: "Can I use Echoverse without an account?",
          answer: "You can explore a few basic features, but an account is required for most functionality.",
        },
        {
          question: "How do I reset my password?",
          answer: "On the login page, click 'Forgot password?' and follow the instructions to reset it via email.",
        },
        {
          question: "Can I change my username?",
          answer: "No, usernames are currently permanent. Choose wisely!",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: "Visa, MasterCard, AmEx, Discover, and PayPal.",
        },
        {
          question: "How do I cancel my subscription?",
          answer: "Navigate to Settings > Subscription and hit 'Cancel'. Your plan will stay active until period end.",
        },
        {
          question: "Do I get a refund if I cancel?",
          answer: "No prorated refunds. Your subscription continues until the billing cycle ends.",
        },
        {
          question: "Can I upgrade/downgrade?",
          answer: "Yes. Upgrades are immediate and prorated. Downgrades take effect at next billing cycle.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: "They're the currency used on AI tools. They reset monthly. Different tools cost different credits.",
        },
        {
          question: "How does the chat assistant work?",
          answer: "It uses large language models to help with general tasks, maintaining context across messages.",
        },
        {
          question: "Can I export my data?",
          answer: "Yes. Go to Settings > Data Management and choose JSON, CSV, or PDF formats.",
        },
        {
          question: "Is my data secure?",
          answer: "Yes. Data is encrypted in transit and at rest. We follow industry-standard security practices.",
        },
      ],
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Find answers to your questions about Echoverse. Browse our documentation, FAQs, and tutorials."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {featuredArticles.map((article, index) => (
                ...
                >
                  ...
                  <p className="text-light-base/70 text-sm mb-3">
                    {article.description}
                  </p>
                ...
                <div className="mb-8">
                  ...
                  {filteredFaqs.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-light-base/70 mb-2">
                        No results found for "{searchQuery}"
                      </p>
                      <p className="text-sm text-light-base/50 mb-4">
            ...
            <TabsContent value="videos" className="mt-6">
              <div className="text-center max-w-2xl mx-auto py-12">
                ...
                <p className="text-light-base/70 mb-6">
                  We're working on tutorials to help you get the most out of Echoverse.
            ...
            <div className="bg-dark-default rounded-lg p-8 flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-light-base/70">
                  Our team is just a message away. Reach out and we’ll assist you ASAP.
                </p>
              </div>
