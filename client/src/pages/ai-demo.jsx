...
import { Sparkles, Globe, FileText, MessageSquare, TrendingUp, Search, Bot, Cpu, Zap, Check, RefreshCw } from "lucide-react";
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {features.map((feature, index) => (<motion.div key={index} initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} onClick={() => setActiveDemo(feature.demo)} className="cursor-pointer">
          ...
          {/* AI Demo Interface */}
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl p-8 border border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Textarea placeholder={demoPrompts[activeDemo]} value={prompt} onChange={(e) => setPrompt(e.target.value)} className="min-h-[120px] resize-none"/>
                <div className="flex gap-2 mt-3">
                  <Button variant="outline" size="sm" onClick={() => setPrompt(demoPrompts[activeDemo])}>
                    <Sparkles className="w-4 h-4 mr-2"/>
                    Use Example
                  </Button>
              ...
              <Button onClick={handleGenerate} disabled={isGenerating || !prompt.trim()} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white h-12">
                {isGenerating ? (<>
              ...
              {result && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mt-6 p-6 bg-slate-50 dark:bg-slate-800 rounded-xl">
          ...
          {/* AI Providers Info */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-16 grid md:grid-cols-2 gap-6">
