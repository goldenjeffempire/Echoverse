...
export default function Login() {
  ...
  return (
    <>
      <Meta
        title="Log In - Echo Website Builder"
        description="Log in to your Echo account to manage your websites, online stores, and more."
      />
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black to-gray-900 p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Log in to your Echo account</p>
          </div>
