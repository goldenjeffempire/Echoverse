...
import { FileIcon, Download, X, Eye } from 'lucide-react';
...
export function FilePreviewTrigger({ file, children }: FilePreviewTriggerProps) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <FilePreview file={file} onClose={() => setIsOpen(false)} />
      )}
    </>
  );
}
