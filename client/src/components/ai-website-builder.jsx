...
import { Bot, Sparkles, Eye, Code, Palette, Layout, Smartphone, Monitor, Tablet, Wand2, Download, Share } from "lucide-react";
      ...
      <Tabs defaultValue="generate" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea placeholder="e.g., Create a modern landing page for a sustainable fashion brand with hero section, product showcase, and contact form..." value={prompt} onChange={(e) => setPrompt(e.target.value)} className="min-h-[100px]" data-testid="textarea-website-prompt"/>
              </div>
              <Button onClick={handleGenerate} disabled={!prompt.trim() || isGenerating} className="w-full" data-testid="button-generate-website">
                {isGenerating ? (<>
        ...
        <TabsContent value="templates" className="space-y-6">
          <Card>
            ...
            <CardContent>
              {isLoadingTemplates ? (<div className="flex justify-center py-8">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div>
                </div>) : (<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {templates.map((template) => (<Card key={template.id} className="hover-elevate cursor-pointer" onClick={() => handleTemplateSelect(template)}>
        ...
        <TabsContent value="customize" className="space-y-6">
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  <Button variant={viewMode === "desktop" ? "default" : "outline"} size="sm" onClick={() => setViewMode("desktop")} data-testid="button-desktop-view">
                    <Monitor className="h-4 w-4"/>
                  </Button>
                  <Button variant={viewMode === "tablet" ? "default" : "outline"} size="sm" onClick={() => setViewMode("tablet")} data-testid="button-tablet-view">
                    <Tablet className="h-4 w-4"/>
                  </Button>
                  <Button variant={viewMode === "mobile" ? "default" : "outline"} size="sm" onClick={() => setViewMode("mobile")} data-testid="button-mobile-view">
