...
import { Users, Shield, Search, Plus, Edit, Trash2, UserCheck, Clock } from "lucide-react";
      ...
      <Tabs defaultValue="users" className="space-y-6">
        ...
        <TabsContent value="users" className="space-y-6">
          <Card>
            ...
            <CardContent>
              {users.length === 0 ? (<p className="text-center text-muted-foreground py-8">No users found.</p>) : (<Table>
                  <TableHeader>
                    <TableRow>
