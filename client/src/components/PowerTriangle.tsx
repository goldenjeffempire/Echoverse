...
export function PowerTriangle() {
  ...
  return (
    <section 
      ref={ref}
      className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 dark:from-black dark:via-purple-950 dark:to-black relative overflow-hidden"
      data-testid="section-power-triangle"
    >
      {/* Cosmic Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <motion.div
            className="relative w-full aspect-square max-w-2xl mx-auto mb-16"
          ...
          >
            ...
            <svg className="w-full h-full absolute inset-0" viewBox="0 0 300 300">
              ...
              <motion.polygon
                points="150,50 50,250 250,250"
                fill="url(#triangleGrad)"
                stroke="url(#triangleGrad)"
                strokeWidth="2"
            ...
            {/* Center Glow */}
            <motion.div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-gradient-to-br from-purple-500 via-pink-500 to-blue-500 rounded-full blur-3xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0.5, 0.3],
              }}
            ...
            {trianglePoints.map((point, index) => {
              ...
              return (
                <motion.div
                  ...
                  data-testid={`card-power-${point.id}`}
                >
                  <Card className={`relative overflow-hidden border-2 transition-all duration-500 ${
                    activePoint === point.id 
                      ...
                      : 'border-slate-700 hover:border-slate-600 focus-visible:border-purple-400'
                  } bg-slate-900/50 backdrop-blur-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900`}>
                    <CardContent className="p-8">
                      {/* Icon with Gradient Background */}
                      <motion.div
                        className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${point.color} p-4 mb-6 mx-auto`}
                      ...
                      <motion.div
                        className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r ${point.color}`}
                        initial={{ width: "0%" }}
                        animate={{ width: activePoint === point.id ? "100%" : "0%" }}
        ...
        >
          ...
          <motion.button
            className="px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white font-bold rounded-full text-lg shadow-2xl"
            whileHover={{ scale: 1.05, boxShadow: "0 20px 60px rgba(139, 92, 246, 0.5)" }}
            whileTap={{ scale: 0.95 }}
            data-testid="button-explore-triangle"
          >
