...
export function VirtualList({ items, height, itemHeight, renderItem, overscan = 3, className = '', }) {
    ...
    return (<div ref={containerRef} onScroll={handleScroll} className={className} style={{
            height: `${height}px`,
            overflow: 'auto',
            position: 'relative',
        }}>
      <div style={{ height: `${totalHeight}px`, position: 'relative' }}>
        <div style={{
          ...
          {visibleItems.map((item, index) => (<div key={visibleRange.start + index} style={{ height: `${itemHeight}px` }}>
