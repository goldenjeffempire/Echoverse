...
import { Check, X, Flag, MessageSquare, User, Clock, Shield } from 'lucide-react';
import { formatDistance } from 'date-fns';
import { cn } from '@/lib/utils';
import { useEffect } from 'react';
export function CommentModeration({ className }) {
    ...
    const handleMarkAsSpam = async (commentId) => {
        setComments(prev => prev.map(c => c.id === commentId ? { ...c, status: 'spam' } : c));
            ...
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {comment.spamScore && comment.spamScore > 0.5 && (<Badge variant="destructive">
                  ...
                  {comment.status === 'pending' && (<div className="flex items-center gap-2">
                    ...
                    setShowRejectDialog(true);
                      ...
                      <Button size="sm" variant="destructive" onClick={() => handleMarkAsSpam(comment.id)}>
