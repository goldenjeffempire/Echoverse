...
export function AIPricingRecommender() {
  ...
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-black dark:via-purple-950 dark:to-black relative overflow-hidden" data-testid="section-ai-pricing">
      {/* Animated Background */}
                          ...
                          {questions[currentQuestion].options.map((option) => (
                            ...
                            >
                              <Label
                                ...
                                className={`flex items-center space-x-3 p-6 rounded-xl border-2 cursor-pointer transition-all ${
              ...
              <div className="text-center mb-12">
                ...
                <h3 className="text-4xl font-bold text-white mb-2">
                  We recommend the <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                    {plans[recommendation as keyof typeof plans].name}
                  </span> plan
                </h3>
                <p className="text-xl text-slate-300">
                ...
                {Object.entries(plans).map(([key, plan]) => {
                  ...
                  return (
                    <motion.div
                      ...
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: isRecommended ? 0 : 0.2 }}
                      whileHover={{ y: -10 }}
                    ...
                    >
                      ...
                      } ${isRecommended ? 'bg-white dark:bg-slate-900' : 'bg-white/50 dark:bg-slate-900/50 opacity-75'}`}>
                        {isRecommended && (
