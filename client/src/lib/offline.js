            ...
            request.onsuccess = () => {
                if ('serviceWorker' in navigator && 'sync' in ServiceWorkerRegistration.prototype) {
                    navigator.serviceWorker.ready
                        ...
                        if (syncManager) {
                            syncManager.register('sync-data')
 ...
 */
export async function syncPendingActions(storageManager, onSync) {
 ...
 */
export function checkForUpdates(registration) {
